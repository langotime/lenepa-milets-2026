...
/usr/bin/time -f "elapsed=%E" uv run python -m pretrain \
  ...
  "run_name=plan113sweep1-ptbxl-wristbandt20-l0-8-pd48-ms96-flow-l4-h128-b2-sm1-s0" \
  ...
  proj_num_layers=1 \
  +proj_backend=invertible_flow \
  proj_flow_n_layers=4 \
  proj_flow_hidden_dim=128 \
  proj_flow_n_blocks=2 \
  proj_flow_s_max=1.0 \
  proj_flow_permute_mode=per_pair \
  ...
  +nepa_wristband_scale=null \
  +nepa_wristband_layers=[] \
  +nepa_wristband_scale_time=20 \
  +nepa_wristband_time_layers=[0,8] \
  +nepa_wristband_scale_batch_time=null \
  +nepa_wristband_batch_time_layers=[] \
  +nepa_wristband_innov_scale=null \
  +nepa_wristband_innov_layers=[] \
  +nepa_wristband_rep_scale=null \
  +nepa_wristband_rep_layers=[] \
  +nepa_wristband_max_samples=96 \
